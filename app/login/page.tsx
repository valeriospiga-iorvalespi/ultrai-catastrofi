...
// ✅ Next.js 16: useSearchParams deve stare in un componente
// wrappato da Suspense. Separiamo la logica in un componente interno.
...
function LoginForm() {
  ...
  return (
    <div style={{ background: "#fff", borderRadius: 16, padding: "40px 44px",
      ...
      boxShadow: "0 24px 64px rgba(0,0,0,0.25)", position: "relative", zIndex: 1 }}>
...
// ✅ Componente principale: wrappa LoginForm in Suspense
